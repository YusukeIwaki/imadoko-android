...
public class RequesterActivity extends BaseActivity implements OnMapReadyCallback {
    ...
    private AnotherUserCacheObserver anotherUserCacheObserver;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        anotherUserCacheObserver = new AnotherUserCacheObserver(this);
        anotherUserCacheObserver.setOnUpdateListener(locationLog ->  {
    ...
    protected void onStop() {
        timer.cancel();
        anotherUserCacheObserver.unsub();
