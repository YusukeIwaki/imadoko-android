...
public class PositioningRequirementCheckAndStartPositioningActivity extends AppCompatActivity {
    ...
    private GoogleApiClient.OnConnectionFailedListener googleApiClientFailureListener = connectionResult -> {
        Toast.makeText(this, "Google Playサービスが使えない", Toast.LENGTH_SHORT).show();
                    ...
                    switch (status.getStatusCode()) {
                        ...
                        case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                            ...
                            try {
                                ...
                                Toast.makeText(this, "位置情報（GPS）を有効にして下さい。じゃないと使えません。", Toast.LENGTH_SHORT).show();
                                SenderService.stop(this);
                                finish();
                            }
                            break;
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        Toast.makeText(this, "パーミッション許可して下さい。じゃないと使えません。", Toast.LENGTH_SHORT).show();
        SenderService.stop(this);
        finish();
    }
